...
Customer.create(name:'testCustomer2',address:'testAddress',scope:'Duplex, Triplex, Quadraplex',email:'test@example.com',username:'exampleUser',password:'asdf',Lat:26.6,Lan:-80.113431)
  ...
  Contractor.create(name:'Advanced Green Technologies' , scope:'Duplex, Triplex, Quadraplex',email:'agreentech@sunnyside.com', Lat: 26.6035, Lng: -80.26531, phone: 9546587634 ,password:'a', address: '2100 NW 21st Ave, Fort Lauderdale, FL 33311')
  Contractor.create(name:'Red Hot Solar',scope:'Duplex, Triplex, Quadraplex',email:'RHS@sunnyside.com', password:'a', Lat: 26.674565, Lng: -80.2331, address:'2414 E Sunrise Blvd, Fort Lauderdale, FL 33304')
  ...
  Contractor.create(name:'A Great Day for Solar', scope:'Duplex, Triplex, Quadraplex', email:'AGDSolar@sunnyside.com', Lat: 26.65, Lng: -80.213431,phone: 9546587634 , password:'a', address:'3020 NE 32nd Ave, Fort Lauderdale, FL 33308')
